      ...
      <div className="max-w-screen-lg mx-auto px-4 md:px-8 py-12">
        ...
        <div className="space-y-16">
          ...
          <div className="bg-gray-900 p-6 md:p-8 rounded-lg shadow-lg transition duration-300 hover:scale-105">
            ...
            <p className="text-xl">
              Engineered a cloud-based financial data analysis architecture using SQL, Airflow, & Snowflake, 
          ...
          <div className="bg-gray-900 p-6 md:p-8 rounded-lg shadow-lg transition duration-300 hover:scale-105">
            ...
            <p className="text-lg italic text-gray-500 mb-4">Data Scientist | July 2021 - August 2022</p>
            <p className="text-xl">
              Led a quantitative analytics project using Python reducing annual losses by 5%, by analysis of underperforming entities, 
              metrics & KPIs, providing strategic recommendations & identifying $8,000 in cost savings.
            </p>
          </div>
          ...
          <div className="bg-gray-900 p-6 md:p-8 rounded-lg shadow-lg transition duration-300 hover:scale-105">
            ...
            <p className="text-lg italic text-gray-500 mb-4">Data Science Intern | January 2021 - June 2021</p>
            <p className="text-xl">
